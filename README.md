...
- [Shopify API library](https://github.com/LionelPerrault/Shopify-Package) adds OAuth to the Express backend. This lets users install the app and grant scope permissions.
